...
public class ProgramsController {
    ...
    public @ResponseBody String deleteProgram(@RequestBody Programs programToDelete){
        Programs program = programsRepository.findProgramsByPid(programToDelete.getPid());
